...
import { List, Text, Title, Button, Spinner } from '@vkontakte/vkui';
...
class Finish extends React.Component {
    ...
    componentDidMount() {
        ...
        if (this.props.prevId != 0) {
            ...
            findDataLevel = jsonExercises.find(item => item.id === this.state.id)
        }
            ...
            <div>
                ...
                <div style={{ paddingTop: 15, marginLeft: 10, marginRight: 10 }}>
                    ...
                    <div style={{ paddingTop: 5 }}>
                        ...
                        <Title level="2" weight="bold" style={{ marginBottom: "10px" }}>Рекомендуем</Title>
